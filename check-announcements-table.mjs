#!/usr/bin/env node
/**
 * 检查 community_announcements 表结构
 */
...
console.log('\n========================================');
console.log('检查 community_announcements 表结构');
console.log('========================================\n');
...
async function checkStructure() {
  ...
  try {
    ...
    console.log('community_announcements 表结构:');
    console.log('----------------------------------------');
    ...
    const pkResult = await client.query(`
      ...
      WHERE tc.table_schema = 'public'
        AND tc.table_name = 'community_announcements'
