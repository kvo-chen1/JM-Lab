#!/usr/bin/env node
/**
 * 应用 submission_full_details 视图修复迁移
 * 执行 SQL 文件中的迁移语句
 */
...
if (!supabaseServiceKey) {
  ...
  console.log('');
  console.log('使用方法:');
  console.log('  set SUPABASE_SERVICE_ROLE_KEY=your_key_here && node scripts/apply-full-details-fix.mjs');
  process.exit(1);
}
...
const migrationPath = join(__dirname, '..', 'supabase', 'migrations', '20260223000008_fix_submission_full_details_view.sql');
