...
if (!supabaseServiceKey) {
  ...
  console.log('');
  console.log('使用方法:');
  console.log('  set SUPABASE_SERVICE_ROLE_KEY=your_key_here && node scripts/apply-score-summary-migration.mjs');
  process.exit(1);
}
...
const migrationPath = join(__dirname, '..', 'supabase', 'migrations', '20260223000005_fix_submission_score_summary_view.sql');
