#!/usr/bin/env node
/**
 * 从 backup.sql 中提取所有 public schema 的数据
 */

import fs from 'fs'

const inputFile = 'backup.sql'
const outputFile = 'all_public_data.sql'

console.log('==========================================')
console.log('   提取所有 public schema 数据')
console.log('==========================================\n')
...
for (let i = 0; i < lines.length; i++) {
  ...
  if (line.startsWith('COPY public.')) {
    ...
    tableCount++
    console.log(`📤 提取表 ${tableCount}: ${currentTable}`)
    continue
  }
