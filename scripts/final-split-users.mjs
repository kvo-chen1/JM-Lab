...
const inputFile = 'c:\\git-repo\\import_batches\\batch_002_users_cleaned.sql';
const outputDir = 'c:\\git-repo\\import_batches';
const MAX_SIZE = 80 * 1024; // 80KB

console.log('🔪 最终分割 users 文件...\n');
...
for (const line of dataLines) {
  ...
  if (currentSize + lineSize > MAX_SIZE && currentLines.length > 1) {
    ...
    const partFilename = `batch_002_users_final_part${String(partNum).padStart(2, '0')}.sql`;
...
console.log(`\n🗑️  删除原文件: batch_002_users_cleaned.sql`);
