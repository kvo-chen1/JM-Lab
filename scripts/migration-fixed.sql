-- ============================================
-- 品牌合作和活动管理数据库迁移（修复版）
-- 执行方式：复制到 Supabase Dashboard -> SQL Editor -> New Query -> Run
-- ============================================

-- 先删除已存在的表（如果存在）
DROP TABLE IF EXISTS public.brand_events CASCADE;
DROP TABLE IF EXISTS public.brand_partnerships CASCADE;
...
-- 删除已存在的策略（如果存在）
DROP POLICY IF EXISTS "任何人可以创建品牌合作申请" ON public.brand_partnerships;
DROP POLICY IF EXISTS "申请人可以查看自己的申请" ON public.brand_partnerships;
DROP POLICY IF EXISTS "管理员可以查看所有品牌合作申请" ON public.brand_partnerships;
DROP POLICY IF EXISTS "管理员可以更新品牌合作申请" ON public.brand_partnerships;
DROP POLICY IF EXISTS "品牌方可以创建活动" ON public.brand_events;
DROP POLICY IF EXISTS "任何人可以查看已发布的品牌活动" ON public.brand_events;
DROP POLICY IF EXISTS "管理员可以查看所有品牌活动" ON public.brand_events;
DROP POLICY IF EXISTS "品牌方可以更新自己的活动" ON public.brand_events;
DROP POLICY IF EXISTS "管理员可以更新所有品牌活动" ON public.brand_events;
