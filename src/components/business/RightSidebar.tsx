...
const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  const hotBrands = BRANDS.slice(0, 4);

  const stats = [
    { label: '入驻品牌', value: '50+', icon: Building2Mock },
    { label: '活跃创作者', value: '10k+', icon: Users },
    { label: '落地案例', value: '120+', icon: TrendingUp },
  ];
...
// Mock component for Building2
function Building2Mock({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3h8a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-8" />
      <path d="M12 3H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8" />
      <path d="M8 7h.01" />
      <path d="M8 11h.01" />
      <path d="M8 15h.01" />
      <path d="M16 7h.01" />
