...
import { X, Save, Image, Lock, Globe } from 'lucide-react';
import { CollectionFolder, UpdateFolderData, FolderVisibility } from '@/types/collectionFolder';

interface FolderEditModalProps {
  folder: CollectionFolder | null;
  onClose: () => void;
  onSave: (data: UpdateFolderData) => Promise<boolean>;
}

export default function FolderEditModal({ folder, onClose, onSave }: FolderEditModalProps) {
  ...
  useEffect(() => {
    if (folder) {
      ...
      setCoverImage(folder.cover_image || '');
