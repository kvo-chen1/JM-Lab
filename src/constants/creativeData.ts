...
export const COMPETITIONS: Competition[] = [
  { id: 'c1', title: '2024 天津文化创意大赛', desc: '展示天津文化魅力的创意赛事', deadline: '2024-12-31' },
  { id: 'c2', title: '老字号品牌焕新计划', desc: '助力传统品牌创新升级', deadline: '2024-11-30' },
];

export const CREATIVE_TEMPLATES: CreativeTemplate[] = [
  { id: 'ct1', name: '节日营销', icon: 'fa-gift', desc: '为传统节日打造专属营销方案', content: '${brand} 节日KV设计；主色中国红+金色；包含传统纹样与节日元素。' },
  { id: 'ct2', name: '产品包装', icon: 'fa-box', desc: '设计独特的品牌包装方案', content: '${brand} 产品包装设计；突出品牌特色；环保材质与现代工艺结合。' },
  { id: 'ct3', name: '社交媒体', icon: 'fa-share-alt', desc: '适合各平台的社交传播内容', content: '${brand} 社交媒体视觉；年轻化设计；适合小红书/微博/抖音传播。' },
  { id: 'ct4', name: '品牌联名', icon: 'fa-handshake', desc: '跨界联名的创意设计方案', content: '${brand} 跨界联名设计；融合双方品牌元素；创造独特视觉记忆点。' },
  { id: 'ct5', name: '文创周边', icon: 'fa-palette', desc: '文化创意周边产品设计', content: '${brand} 文创周边设计；提取品牌文化符号；实用与美观并重。' },
  { id: 'ct6', name: '门店空间', icon: 'fa-store', desc: '线下门店空间设计方案', content: '${brand} 门店空间设计；传统与现代融合；营造沉浸式品牌体验。' },
];
