              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                <div className="flex items-end gap-4">
                  <motion.div
                    ...
                    className="w-20 h-20 md:w-24 md:h-24 rounded-2xl overflow-hidden border-4 border-white shadow-xl"
                  >
                    <img
                      src={brand.brand_logo}
                      alt={brand.brand_name}
                  ...
                  <div className="flex-1 pb-2">
                    ...
                    {brand.brand_slogan && (
                      <p className="text-white/80 text-sm md:text-base">{brand.brand_slogan}</p>
                    )}
                  </div>
