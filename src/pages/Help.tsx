...
export default function Help() {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      id: 'faq-20',
      question: '如何参加创意比赛？',
      answer: '进入“创作中心”的“赛事评选”页面，查看正在进行的比赛。点击比赛卡片可以查看详情和要求，使用“立即报名”按钮即可提交你的作品参与比赛。',
      category: 'community'
    },
    {
      id: 'faq-21',
      question: '作品上传支持哪些格式？',
      answer: '我们支持多种常见的媒体格式，包括图片（JPG, PNG, GIF）、视频（MP4）和文档（PDF）。单个文件大小限制请参考上传页面的具体说明（通常为50MB）。',
      category: 'technical'
    }
  ]
