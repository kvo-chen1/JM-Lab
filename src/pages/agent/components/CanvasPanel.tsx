      ...
      >
        ...
        {posterDesign.isActive && (
          <PosterCanvas
            ...
            textContent={posterDesign.textContent}
            editableElements={posterDesign.editableElements}
            selectedElementId={posterDesign.selectedElementId}
            isEditMode={posterDesign.isEditMode}
            onSelectElement={posterDesign.selectElement}
            onUpdateElement={posterDesign.updateElement}
            onDeleteElement={posterDesign.deleteElement}
            onUpdateTextContent={posterDesign.updateTextContent}
          />
        )}
