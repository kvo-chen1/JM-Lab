  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-white">交易管理</h2>
          <p className="text-sm text-gray-500 mt-0.5">管理订单、处理发货、跟踪物流</p>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-[#1a1a1a]">
              <tr>
                <th className="text-left px-4 py-3 text-sm font-medium text-gray-400">订单号</th>
                <th className="text-left px-4 py-3 text-sm font-medium text-gray-400">买家</th>
                <th className="text-left px-4 py-3 text-sm font-medium text-gray-400">商品</th>
                ...
                <th className="text-left px-4 py-3 text-sm font-medium text-gray-400">下单时间</th>
            ...
            <tbody className="divide-y divide-[#2a2a2a]">
              {filteredOrders.map((order, index) => (
                ...
                >
                  <td className="px-4 py-3 text-sm text-white">{order.orderNo}</td>
                  <td className="px-4 py-3 text-sm text-gray-300">{order.buyer}</td>
                  <td className="px-4 py-3 text-sm text-gray-300">{order.product}</td>
