  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-white">评论管理</h2>
          <p className="text-sm text-gray-500 mt-0.5">查看和回复用户评价</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-[#141414] rounded-xl p-4 border border-[#2a2a2a]">
          <p className="text-sm text-gray-500">五星好评</p>
          <p className="text-2xl font-bold text-emerald-400">{stats.fiveStar}</p>
        </div>
        <div className="bg-[#141414] rounded-xl p-4 border border-[#2a2a2a]">
          <p className="text-sm text-gray-500">待回复</p>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-sm text-gray-500">{review.createTime}</span>
                  {getStatusBadge(review.status)}
                </div>

                {/* 商品信息 */}
                <p className="text-sm text-gray-400 mb-2">购买商品：{review.product}</p>
