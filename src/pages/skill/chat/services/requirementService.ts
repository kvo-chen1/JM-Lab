...
const INTENT_REQUIREMENTS: Record<IntentType, RequirementField[]> = {
  ...
  'web-search': [],
  'compound-generation': [
    { key: 'brandName', label: '品牌名称', description: '品牌或项目名称', required: false, type: 'text', placeholder: '例如：绿野科技' },
    { key: 'mainTask', label: '主要任务', description: '最核心的设计任务', required: true, type: 'text', placeholder: '例如：Logo设计' },
    { key: 'subTasks', label: '关联任务', description: '需要同时完成的其他任务', required: false, type: 'textarea', placeholder: '例如：名片设计、海报设计、品牌文案等' },
  ],
  'refinement': [
    { key: 'modificationType', label: '修改类型', description: '要修改的内容类型', required: false, type: 'select', options: ['颜色', '风格', '尺寸', '内容', '整体'] },
    { key: 'modificationDetail', label: '修改详情', description: '具体的修改要求', required: true, type: 'textarea', placeholder: '例如：换成蓝色系、风格更简约等' },
  ],
  'general': [],
  'greeting': [],
  'help': [],
