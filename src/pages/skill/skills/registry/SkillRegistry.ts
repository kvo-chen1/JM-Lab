...
export class SkillRegistry {
  ...
  register(skill: ISkill, priority: number = this.config.defaultPriority!, config?: Record<string, any>): boolean {
  ...
  getSkillsByAgent(agent: string): ISkill[] {
  ...
  recordExecution(skillId: SkillId, success: boolean, executionTime: number): void {
