...
CREATE TABLE IF NOT EXISTS ai_feedback (
    ...
    feedback_type TEXT DEFAULT 'satisfaction' CHECK (feedback_type IN ('satisfaction', 'quality', 'accuracy', 'helpfulness', 'other')),
    comment TEXT,
...
COMMENT ON TABLE ai_feedback IS 'AI反馈表，存储用户对AI回复的评分和反馈';
