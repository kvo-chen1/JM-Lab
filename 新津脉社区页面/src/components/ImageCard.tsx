  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div className="mb-4 break-inside-avoid relative group cursor-zoom-in rounded-[24px] overflow-hidden">
           {/* Image */}
           {imgError ? (
             <div 
               className="w-full bg-muted flex flex-col items-center justify-center p-4 text-muted-foreground"
          ...
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-4 flex flex-col justify-between">
            ...
            <div className="flex justify-end pointer-events-auto">
                <Button 
                    className="rounded-full bg-primary hover:bg-[#ad081b] text-white font-semibold px-5 h-10 shadow-md border-none"
                    onClick={(e) => {
                        e.stopPropagation(); 
            ...
            <div className="flex flex-col gap-2 pointer-events-auto">
                {/* Prompt on Hover */}
                <p className="text-white/90 text-xs line-clamp-2 font-medium drop-shadow-md mb-1">
                    {image.prompt}
                </p>
                ...
                <div className="flex justify-end gap-2">
                    <Button
                        size="icon"
                        className="rounded-full bg-white/90 hover:bg-white text-foreground w-9 h-9 shadow-sm border-none"
      ...
      <DialogContent className="w-[95vw] sm:max-w-[95vw] md:max-w-[1400px] h-[90vh] md:h-[85vh] overflow-hidden bg-background border-none p-0 rounded-[32px] shadow-2xl flex flex-col md:flex-row focus:outline-none">
          <DialogTitle className="hidden">Image Detail</DialogTitle>
          
            {/* Left Image Side - Larger Area */}
            <div className="flex-1 md:flex-[1.5] lg:flex-[2] bg-black flex items-center justify-center relative overflow-hidden h-[40vh] md:h-full min-w-0 md:min-w-[50%]">
            ...
            <div className="w-full md:w-[400px] flex-shrink-0 p-6 md:p-8 flex flex-col gap-6 bg-background h-full overflow-y-auto">
                <div className="flex items-center justify-between sticky top-0 bg-background z-10 pb-4">
                     <div className="flex gap-2">
                        <Button size="icon" variant="ghost" className="rounded-full"><MoreHorizontal /></Button>
                        <Button size="icon" variant="ghost" className="rounded-full"><Share2 /></Button>
                     </div>
                     <Button className="rounded-full bg-primary hover:bg-[#ad081b] text-white px-6 font-bold shadow-none">
                        保存
                     </Button>
                </div>
                ...
                <div className="flex items-center gap-4 py-4 border-t border-b">
                     ...
                     <div className="flex-1">
                         <p className="font-semibold text-sm">AI 创作者</p>
                         <p className="text-xs text-muted-foreground">粉丝: 1.2k</p>
                     </div>
                     <Button variant="secondary" className="rounded-full font-semibold">关注</Button>
                </div>
                ...
                <div className="mt-auto pt-6 flex flex-col gap-4">
                     <Button className="w-full rounded-full h-12 text-lg font-semibold" onClick={handleDownload}>
                        下载原图
                     </Button>
